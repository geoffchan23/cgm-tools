...
/**
 * Debug-only ADB entry point for Claude Code extraction runs. Inserting
 * through Room (instead of editing the SQLite file externally) keeps WAL
 ...
 *
 *   adb shell am broadcast -n .../.IngestReceiver --es op clear-events --es day 2026-09-01
 */
        ...
        CoroutineScope(Dispatchers.IO).launch {
            try {
                when (op) {
                    ...
                    "clear-events" -> dao.deleteEventsForDay(day)
